...
public:
    long long minimumTotalDistance(vector<int>& robot, vector<vector<int>>& factory) {
        ...
        vector<vector<long long>> memo(robot.size(), vector<long long>(factoryPositions.size(), -1));
    ...
    long long calculateMinDistance(int robotIdx, int factoryIdx,
                                   vector<int>& robot, vector<int>& factoryPositions,
        ...
        // Take the option with the minimum distance and store in memo
